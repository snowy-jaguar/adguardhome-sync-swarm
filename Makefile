...
mocks: tb.mockgen
	$(TB_MOCKGEN) -package client -destination pkg/mocks/client/mock.go github.com/snowy-jaguar/adguardhomesync-swarm/pkg/client Client
	$(TB_MOCKGEN) -package client -destination pkg/mocks/flags/mock.go github.com/snowy-jaguar/adguardhomesync-swarm/pkg/config Flags
